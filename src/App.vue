...
<template>
  <div class="set-center-page bg-mytheme-primary">
    <!-- Main Menu -->
    <div
      id="main-menu"
    ...
    >
      <div id="life-point">
        <h3 class="sub-heading-text mb-1 font-bold text-mytheme-base-100">
          Life Point
        </h3>
      ...
      <div class="w-4/5" v-if="!isOptionsExist()">
        <input
          ...
          class="input input-bordered input-lg w-full answer-box bg-mytheme-base-200"
    ...
    >
      <div id="result-content" class="bg-white p-8 rounded-lg text-center">
        <div id="header-section">
          <h2 class="heading-text text-mytheme-error">Game Ended</h2>
        </div>
        <p id="score-section" class="sub-heading-text my-4 text-mytheme-error">
        ...
        <div id="btn-section" class="flex justify-evenly">
          <p
            id="home-btn"
            @click="actions.reset"
            class="bg-mytheme-primary button-icon hover-button set-child-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
          ...
          <p
            ...
            class="bg-mytheme-accent button-icon hover-button set-child-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
